...
<header
    ...
    <nav class="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
        ...
        <div class="flex items-center justify-between">
            <a class="flex-none text-xl font-semibold dark:text-white" href="{{ route('landing.home.index') }}"
                aria-label="Brand">PerbaiQin</a>
            <div class="sm:hidden">
                <button type="button"
        ...
        <div id="navbar-collapse-with-animation"
            ...
            <div
                ...
                <x-landing.navlink href="{{ route('landing.ask-technician.index') }}">Ask Technician</x-landing.navlink>
                <x-landing.navlink href="#">Technicians</x-landing.navlink>
                <x-landing.navlink href="#">Appoinment</x-landing.navlink>
                <x-landing.navlink href="#">Videos</x-landing.navlink>
                <x-landing.navlink href="#">Products</x-landing.navlink>
